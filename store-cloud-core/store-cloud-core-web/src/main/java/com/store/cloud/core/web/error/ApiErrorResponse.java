...
public record ApiErrorResponse(
    ...
    public static ApiErrorResponse of(ErrorCodes canonical, String requestPath, String message, String traceId) {
        String msg = message != null ? message : canonical.defaultMessage();
        return new ApiErrorResponse(requestPath, canonical.code(), msg, OffsetDateTime.now(), traceId, null);
    }
    ...
    public static ApiErrorResponse of(
        ...
        String msg =
                message != null
                        ? message
                        : ErrorCodes.fromNumericCode(numericCode)
                                .map(ErrorCodes::defaultMessage)
                                .orElseGet(() -> String.valueOf(numericCode));
        return new ApiErrorResponse(requestPath, numericCode, msg, OffsetDateTime.now(), traceId, copy);
    }
}
